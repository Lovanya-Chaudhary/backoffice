...
//@NamedQueries({
//    @NamedQuery(name = "GET_SKUS_FOR_SITE", query = "Select i From InvbysitEntity i Where i.skuNo = :skuNo And i.siteNo IN (:sites) "),
//    @NamedQuery(name = "GET_INVBYSIT_SKUS_FOR_SITE", query = "Select i From InvbysitEntity i Where i.skuNo IN (:skuNos) And i.siteNo = :site ")
//})
@Entity
@Table(name = "INVBYSIT")
public class InvbysitEntity
    extends RNetAbstractEntity<InvbysitEntity, InvbysitDTO>
{
    ...
    /**
     * <p>ManyToOne relationship to {@link InvtoryEntity InvtoryEntity}.</p><p><b>Column Mapping:</b><br/>
    ...
    /**
     * <p>Static value for named query 'GET_SKUS_FOR_SITE'<p>
     * <p>JPA Query:
     * </p>{@code Select i From InvbysitEntity i Where i.skuNo = :skuNo And i.siteNo IN (:sites) }
     * 
     */
    public final static String GET_SKUS_FOR_SITE = "GET_SKUS_FOR_SITE";
    /**
     * <p>Static value for named query 'GET_INVBYSIT_SKUS_FOR_SITE'<p>
     * <p>JPA Query:
     * </p>{@code Select i From InvbysitEntity i Where i.skuNo IN (:skuNos) And i.siteNo = :site }
     * 
     */
    public final static String GET_INVBYSIT_SKUS_FOR_SITE = "GET_INVBYSIT_SKUS_FOR_SITE";

    /**
     * <P>Empty constructor used to create new InvbysitEntity.</P>
     * 
     */
    public InvbysitEntity() {
    ...
    /**
     * Constructor used to create a new InvbysitEntity where the identifier will be created by copying the fields of the provided sourceId.
     * 
     */
    public InvbysitEntity(InvbysitEntityId sourceId) {
    ...
    /**
     * Constructor used to create a InvbysitEntity where the identifier will be created internally using the id arguments provided.  This is a convenient constructor used instead of instantiating a new identifier.
     * 
     */
    public InvbysitEntity(Integer skuNo, Integer siteNo) {
    ...
    /**
     * Constructor used to create a InvbysitEntity where contents are provided by an object array typically returned by a native query
     * 
     */
    public InvbysitEntity(Object[] objectArray) {
     ...
     * 
     */
    public InvbysitEntity(InvbysitFullEntity source, InvbysitEntityId sourceId) {
        this.identifier = new InvbysitEntityId(sourceId.getSkuNo(), sourceId.getSiteNo());
     ...
     * 
     */
    public InvbysitEntity(InvbysitFullEntity source) {
     ...
     * 
     */
    public InvbysitEntity(InvbysitEntity source, InvbysitEntityId sourceId) {
        this.identifier = new InvbysitEntityId(sourceId.getSkuNo(), sourceId.getSiteNo());
     ...
     * 
     */
    public InvbysitEntity(InvbysitEntity source) {
        this.identifier = new InvbysitEntityId(source.getIdentifier().getSkuNo(), source.getIdentifier().getSiteNo());
     ...
     */
    @Parent
    public InvtoryEntity getInvtory() {
        return invtory;
    }
     ...
     * 
     */
    public void setInvtory(InvtoryEntity invtory) {
    ...
    /**
     * <P>Used to copy a InvbysitEntity including non-identifier fields only.</P>
     * 
     */
    public InvbysitEntity copyData() {
        final InvbysitEntity copy = new InvbysitEntity();
    ...
    /**
     * <P>Used to copy a InvbysitEntity including its identifier.</P>
     * 
     */
    public InvbysitEntity copyDataAndId() {
        final InvbysitEntity copy = new InvbysitEntity();
    ...
    /**
     * <P>Used to copy a InvbysitEntity including data and GENERATED identifiers only.</P>
     * 
     */
    public InvbysitEntity copyDataAndIdNonGenerated() {
        final InvbysitEntity copy = new InvbysitEntity();
    ...
    public static InvbysitDTO toDTO(InvbysitEntity entity) {
        Map<Object, Object> map = new HashMap<Object, Object>();
        return InvbysitEntity.toDTO(entity, map);
    }

    public static InvbysitDTO toDTO(InvbysitEntity entity, Map<Object, Object> map) {
        try {
            if (entity == null) {
                return null;
            }
            ...
            if (map == null) {
                ...
                if (map.get(entity)!= null) {
                    return ((InvbysitDTO) map.get(entity));
                }
            }
    ...
    public static InvbysitEntity toEntity(InvbysitDTO dto) {
        Map<Object, Object> map = new HashMap<Object, Object>();
        return InvbysitEntity.toEntity(dto, map);
    }

    public static InvbysitEntity toEntity(InvbysitDTO dto, Map<Object, Object> map) {
        try {
            if (dto == null) {
                return null;
            }
            ...
            if ((map!= null)&&(map.get(dto)!= null)) {
                return ((InvbysitEntity) map.get(dto));
            }
            	
            return ((InvbysitEntity) DtoToEntity.toEntity(InvbysitEntity.class, ((DataTransferObject) dto)));
        } catch (Throwable e) {
            throw new RNetUnexpectedException(new RNetExceptionProxy(e));
        }
    }

    public void assignAllChildren(InvbysitDTO dto, Map<Object, Object> map) {
    ...
    public void assignAllParents(Map<Object, Object> map) {
        InvbysitDTO dto = toSimpleDto(map);
        	
        InvtoryDTO invtoryDto = ((InvtoryDTO) map.get(this.invtory));
        if (invtoryDto!= null) {
    ...
    protected InvbysitDTO toSimpleDto(Map<Object, Object> map) {
        if (map.get(this)!= null) {
            return ((InvbysitDTO) map.get(this));
        }
        try {
            InvbysitDTO dto = new InvbysitDTO();
    ...
    public InvbysitEntity toSimpleEntity(DataTransferObject dto, Map<Object, Object> map) {
        if (map.get(dto)!= null) {
            return ((InvbysitEntity) map.get(dto));
        }
        try {
            InvbysitDTO oldDto = ((InvbysitDTO) dto);
            InvbysitEntity entity = new InvbysitEntity();
    ...
    public static List<InvbysitDTO> toDTOList(Collection<InvbysitEntity> entities) {
        if (entities == null) {
            return null;
        }
        	
        List<InvbysitDTO> dtos = new ArrayList<InvbysitDTO>();
        for (InvbysitEntity entity: entities) {
    ...
    @Deprecated
    public static List<InvbysitDTO> toDTO(Collection<InvbysitEntity> entities) {
    ...
    public static Set<InvbysitEntity> toEntitySet(Collection<InvbysitDTO> dtos) {
        if (dtos == null) {
            return null;
        }
        	
        Set<InvbysitEntity> entities = new HashSet<InvbysitEntity>();
        for (InvbysitDTO dto: dtos) {
    ...
    @Deprecated
    public static Set<InvbysitEntity> toEntity(Collection<InvbysitDTO> dtos) {
        return toEntitySet(dtos);
    }

    public static SortedSet<InvbysitEntity> toEntitySortedSet(Collection<InvbysitDTO> dtos) {
        if (dtos == null) {
            return null;
        }
        	
        SortedSet<InvbysitEntity> entities = new TreeSet<InvbysitEntity>();
        for (InvbysitDTO dto: dtos) {
            entities.add(toEntity(dto));
        }
    ...
    @Deprecated
    public static SortedSet<InvbysitEntity> toEntitySorted(Collection<InvbysitDTO> dtos) {
        return toEntitySortedSet(dtos);
    }

    public static List<InvbysitEntity> toEntityList(Collection<InvbysitDTO> dtos) {
        if (dtos == null) {
            return null;
        }
        	
        List<InvbysitEntity> entities = new ArrayList<InvbysitEntity>();
        for (InvbysitDTO dto: dtos) {
            entities.add(toEntity(dto));
        }
    ...
    public boolean equals(Object obj) {
        ...
        final InvbysitEntity other = ((InvbysitEntity) obj);
     ...
     * 
     */
    public int compareTo(InvbysitEntity other) {
    ...
    public String toString() {
        ...
        temp.append("\n");
        temp.append("InvbysitEntity (INVBYSIT)\n");
