...
//@NamedQueries({
//    @NamedQuery(name = "GET_ITEM_DESCRIPTION", query = "Select i.description From InvtoryEntity i Where i.skuNo = :skuNo "),
//    @NamedQuery(name = "GET_INVTORY_COUNT_FOR_MFG_CD", query = "Select Count(i.mfgCd) From InvtoryEntity i Where i.mfgCd = :mfgCd "),
//    @NamedQuery(name = "GET_MFG_CD_FOR_SKU", query = "Select i.mfgCd From InvtoryEntity i Where i.skuNo = :skuNo "),
//    @NamedQuery(name = "GET_MFG_CD_FOR_SKUS", query = "Select i From InvtoryEntity i Where i.skuNo In (:skuNos) ")
//})
@Entity
@Table(name = "INVTORY")
public class InvtoryEntity
    extends RNetAbstractEntity<InvtoryEntity, InvtoryDTO>
{
    ...
    /**
     * <p>Static value for named query 'GET_ITEM_DESCRIPTION'<p>
     * <p>JPA Query:
     * </p>{@code Select i.description From InvtoryEntity i Where i.skuNo = :skuNo }
     * 
     */
    public final static String GET_ITEM_DESCRIPTION = "GET_ITEM_DESCRIPTION";
    /**
     * <p>Static value for named query 'GET_INVTORY_COUNT_FOR_MFG_CD'<p>
     * <p>JPA Query:
     * </p>{@code Select Count(i.mfgCd) From InvtoryEntity i Where i.mfgCd = :mfgCd }
     * 
     */
    public final static String GET_INVTORY_COUNT_FOR_MFG_CD = "GET_INVTORY_COUNT_FOR_MFG_CD";
    /**
     * <p>Static value for named query 'GET_MFG_CD_FOR_SKU'<p>
     * <p>JPA Query:
     * </p>{@code Select i.mfgCd From InvtoryEntity i Where i.skuNo = :skuNo }
     * 
     */
    public final static String GET_MFG_CD_FOR_SKU = "GET_MFG_CD_FOR_SKU";
    /**
     * <p>Static value for named query 'GET_MFG_CD_FOR_SKUS'<p>
     * <p>JPA Query:
     * </p>{@code Select i From InvtoryEntity i Where i.skuNo In (:skuNos) }
     * 
     */
    public final static String GET_MFG_CD_FOR_SKUS = "GET_MFG_CD_FOR_SKUS";

    /**
     * <P>Empty constructor used to create new InvtoryEntity.</P>
     * 
     */
    public InvtoryEntity() {
    ...
    /**
     * Constructor used to create a new InvtoryEntity where the identifier will be created by copying the fields of the provided sourceId.
     * 
     */
    public InvtoryEntity(InvtoryEntityId sourceId) {
    ...
    /**
     * Constructor used to create a InvtoryEntity where the identifier will be created internally using the id arguments provided.  This is a convenient constructor used instead of instantiating a new identifier.
     * 
     */
    public InvtoryEntity(Integer skuNo) {
    ...
    /**
     * Constructor used to create a InvtoryEntity where contents are provided by an object array typically returned by a native query
     * 
     */
    public InvtoryEntity(Object[] objectArray) {
     ...
     * 
     */
    public InvtoryEntity(InvtoryFullEntity source, InvtoryEntityId sourceId) {
        this.identifier = new InvtoryEntityId(sourceId.getSkuNo());
     ...
     * 
     */
    public InvtoryEntity(InvtoryFullEntity source) {
     ...
     * 
     */
    public InvtoryEntity(InvtoryEntity source, InvtoryEntityId sourceId) {
        this.identifier = new InvtoryEntityId(sourceId.getSkuNo());
     ...
     * 
     */
    public InvtoryEntity(InvtoryEntity source) {
        this.identifier = new InvtoryEntityId(source.getIdentifier().getSkuNo());
    ...
    /**
     * <P>Used to copy a InvtoryEntity including non-identifier fields only.</P>
     * 
     */
    public InvtoryEntity copyData() {
        final InvtoryEntity copy = new InvtoryEntity();
    ...
    /**
     * <P>Used to copy a InvtoryEntity including its identifier.</P>
     * 
     */
    public InvtoryEntity copyDataAndId() {
        final InvtoryEntity copy = new InvtoryEntity();
    ...
    /**
     * <P>Used to copy a InvtoryEntity including data and GENERATED identifiers only.</P>
     * 
     */
    public InvtoryEntity copyDataAndIdNonGenerated() {
        final InvtoryEntity copy = new InvtoryEntity();
    ...
    public static InvtoryDTO toDTO(InvtoryEntity entity) {
        Map<Object, Object> map = new HashMap<Object, Object>();
        return InvtoryEntity.toDTO(entity, map);
    }

    public static InvtoryDTO toDTO(InvtoryEntity entity, Map<Object, Object> map) {
        try {
            if (entity == null) {
                return null;
            }
            ...
            if (map == null) {
                ...
                if (map.get(entity)!= null) {
                    return ((InvtoryDTO) map.get(entity));
                }
            }
    ...
    public static InvtoryEntity toEntity(InvtoryDTO dto) {
        Map<Object, Object> map = new HashMap<Object, Object>();
        return InvtoryEntity.toEntity(dto, map);
    }

    public static InvtoryEntity toEntity(InvtoryDTO dto, Map<Object, Object> map) {
        try {
            if (dto == null) {
                return null;
            }
            ...
            if ((map!= null)&&(map.get(dto)!= null)) {
                return ((InvtoryEntity) map.get(dto));
            }
            	
            return ((InvtoryEntity) DtoToEntity.toEntity(InvtoryEntity.class, ((DataTransferObject) dto)));
        } catch (Throwable e) {
            throw new RNetUnexpectedException(new RNetExceptionProxy(e));
        }
    }

    public void assignAllChildren(InvtoryDTO dto, Map<Object, Object> map) {
    ...
    protected InvtoryDTO toSimpleDto(Map<Object, Object> map) {
        if (map.get(this)!= null) {
            return ((InvtoryDTO) map.get(this));
        }
        try {
            InvtoryDTO dto = new InvtoryDTO();
    ...
    public InvtoryEntity toSimpleEntity(DataTransferObject dto, Map<Object, Object> map) {
        if (map.get(dto)!= null) {
            return ((InvtoryEntity) map.get(dto));
        }
        try {
            InvtoryDTO oldDto = ((InvtoryDTO) dto);
            InvtoryEntity entity = new InvtoryEntity();
    ...
    public static List<InvtoryDTO> toDTOList(Collection<InvtoryEntity> entities) {
        if (entities == null) {
            return null;
        }
        	
        List<InvtoryDTO> dtos = new ArrayList<InvtoryDTO>();
        for (InvtoryEntity entity: entities) {
    ...
    @Deprecated
    public static List<InvtoryDTO> toDTO(Collection<InvtoryEntity> entities) {
    ...
    public static Set<InvtoryEntity> toEntitySet(Collection<InvtoryDTO> dtos) {
        if (dtos == null) {
            return null;
        }
        	
        Set<InvtoryEntity> entities = new HashSet<InvtoryEntity>();
        for (InvtoryDTO dto: dtos) {
    ...
    @Deprecated
    public static Set<InvtoryEntity> toEntity(Collection<InvtoryDTO> dtos) {
        return toEntitySet(dtos);
    }

    public static SortedSet<InvtoryEntity> toEntitySortedSet(Collection<InvtoryDTO> dtos) {
        if (dtos == null) {
            return null;
        }
        	
        SortedSet<InvtoryEntity> entities = new TreeSet<InvtoryEntity>();
        for (InvtoryDTO dto: dtos) {
            entities.add(toEntity(dto));
        }
    ...
    @Deprecated
    public static SortedSet<InvtoryEntity> toEntitySorted(Collection<InvtoryDTO> dtos) {
        return toEntitySortedSet(dtos);
    }

    public static List<InvtoryEntity> toEntityList(Collection<InvtoryDTO> dtos) {
        if (dtos == null) {
            return null;
        }
        	
        List<InvtoryEntity> entities = new ArrayList<InvtoryEntity>();
        for (InvtoryDTO dto: dtos) {
            entities.add(toEntity(dto));
        }
    ...
    public boolean equals(Object obj) {
        ...
        final InvtoryEntity other = ((InvtoryEntity) obj);
     ...
     * 
     */
    public int compareTo(InvtoryEntity other) {
    ...
    public String toString() {
        ...
        temp.append("\n");
        temp.append("InvtoryEntity (INVTORY)\n");
